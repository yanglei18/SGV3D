...
if __name__ == "__main__":
    ...
    val_background_ids, background_count, P2_cache = get_background_ids(src_root, list(set(raw_frame_ids)), cls_focus, 10)
    ...
    if os.path.exists(outputs_data_dir) and count_files_in_dir(outputs_data_dir) > 10000:
        num_frames = 3
        combine_frame_ids, count = combination_process(raw_frame_ids[:300], src_root, P2_cache, background_ids, combine_frame_ids, num_frames, count, True, vis)
    else:
