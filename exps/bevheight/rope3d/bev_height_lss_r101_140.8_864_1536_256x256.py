...
gt_label_path = "data/rope3d-kitti/training/label_eval"
...
backbone_conf = {
    ...
    'height_net_conf':
    dict(in_channels=512, mid_channels=512, semantic_channels=semantic_channels),
    'is_train_height':
    is_train_height,
    'is_bsm': False
}
...
def main(args: Namespace) -> None:
    ...
    checkpoint_callback = ModelCheckpoint(dirpath='./outputs/bsm_bev_height_lss_r101_140.8_864_1536_256x256/checkpoints', filename='{epoch}', every_n_epochs=5, save_last=True, save_top_k=-1)
    ...
    if args.evaluate:
        ...
        backup_codebase(os.path.join('./outputs/bsm_bev_height_lss_r101_140.8_864_1536_256x256', 'backup'))
        trainer.fit(model)
...
def run_cli():
    ...
    parser.set_defaults(
        ...
        precision=32,
        default_root_dir='./outputs/bsm_bev_height_lss_r101_140.8_864_1536_256x256')
