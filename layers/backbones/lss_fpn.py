...
from layers.backbones.sam_encoder import build_sam_vit_b
...
class LSSFPN(nn.Module):
    def __init__(self, x_bound, y_bound, z_bound, d_bound, final_dim,
                 output_channels, downsample_factor, img_backbone_conf,
                 img_neck_conf, height_net_conf, is_train_height, is_bsm=False):
